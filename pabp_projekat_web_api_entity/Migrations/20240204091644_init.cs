    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            /*migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ispitni___C7D0FE7210C9F95B", x => x.ID_ROKA);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__profesor__63597FD79C4E8F7A", x => x.ID_PROFESORA);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__student__0FD2897837FE30F5", x => x.ID_STUDENTA);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__predmet__2C40E4E24B422B41", x => x.ID_PREDMETA);
                    table.ForeignKey(
